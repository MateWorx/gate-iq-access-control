  ...
  public: {
    Tables: {
      ...
      incidents: {
        ...
        Relationships: [
          {
            foreignKeyName: "incidents_security_officer_id_fkey"
            columns: ["security_officer_id"]
            isOneToOne: false
            referencedRelation: "security_officers"
            referencedColumns: ["id"]
          },
        ]
      }
      ...
      scan_logs: {
        ...
        Relationships: [
          {
            foreignKeyName: "scan_logs_security_officer_id_fkey"
            columns: ["security_officer_id"]
            isOneToOne: false
            referencedRelation: "security_officers"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "scan_logs_visitor_id_fkey"
            columns: ["visitor_id"]
            isOneToOne: false
      ...
      visitors: {
        Row: {
          ...
          full_name: string
          geo_location_check_in: Json | null
          geo_location_check_out: Json | null
          id: string
          id_number: string | null
          photo: string | null
